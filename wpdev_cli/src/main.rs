            ...
            match sites_matches.subcommand() {
                Some(("create", create_matches)) => {
                    ...
                    let instance = utils::with_spinner(
                        commands::create_instance(options),
                        "Creating instance"
                        ).await?;
